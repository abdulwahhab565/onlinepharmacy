				...
				<div class="container-fluid">
					<form action="" id="product-form">
						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						    <label for="prescription" class="control-label">Prescription Information</label>
						    <textarea rows="4" name="prescription" id="prescription" class="form-control form-control-sm rounded-0"><?php echo isset($prescription) ? $prescription : ''; ?></textarea>
						</div>
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
